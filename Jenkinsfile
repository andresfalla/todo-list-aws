        ...
        stage('Get Code') {
            steps {
                ...
                sh '''
                    ...
                    "https://raw.githubusercontent.com/andresfalla/todo-list-aws-config/staging/samconfig.toml?nocache=$(date +%s)"

                    # SAM usa primero ./samconfig.toml
                    mkdir -p .aws-sam
